...
> Answer: Because less data has to be processed transitions and everything are smoother
and faster
...
> Answer: Are components where the data on the DOM is controlled by us via state
vs DOM elements like form inputs
